...
public class GenericMethods {
	...
	public List<WebElement> getElementList(String locator, String type) {
		...
		if (elementList.isEmpty()) {
			System.out.println("Element(s) not found with " + type +": " + locator);
			
		} else {
			System.out.println("Element(s) found with " + type +": " + locator);
		}
		return elementList;
	}
	...
	public WebElement waitForElement(By locator, int timeout) {
		...
		try {
			System.out.println("Locating element for: " + timeout + " seconds");
			
			WebDriverWait wait = new WebDriverWait(driver, timeout);
			element = wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
		} catch (Exception e) {
			System.out.println("Element not found. Timeout exceeded.");
		}
		return element;
	}
	...
	public void clickWhenReady(By locator, int timeout) {
		...
		try {
			...
			element.click();
			System.out.println("Element found. Clicking element.");
		} catch (Exception e) {
			System.out.println("Element not found. Timeout exceeded.");
		}
